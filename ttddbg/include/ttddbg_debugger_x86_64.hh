...
namespace ttddbg
{
	...
	public:
		 ...
		 */
		explicit DebuggerX86_64(std::shared_ptr<ttddbg::Logger> logger, Plugin *plugin);
	};
	...
	public:
		 ...
		 * \brief	ctor
		 */
		explicit DebuggerManagerX86_64(std::shared_ptr<ttddbg::Logger> logger, Plugin *plugin);

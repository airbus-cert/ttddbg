...
namespace ttddbg
{
	...
	/**********************************************************************/
	DebuggerManagerX86_64::DebuggerManagerX86_64(std::shared_ptr<ttddbg::Logger> logger, Plugin *plugin)
	...
	/**********************************************************************/
	DebuggerX86_64::DebuggerX86_64(std::shared_ptr< ttddbg::Logger> logger, Plugin *plugin)
